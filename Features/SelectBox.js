...
// Khá»Ÿi táº¡o giÃ¡ trá»‹ default cho props khi khÃ´ng nháº­n Ä‘Æ°á»£c
// tá»« parent
    ...
    <View>
        ...
        <View style={styles.modal}>
          <View style={styles.content}>
            ...
            <View style={styles.title}>
              <Text style={{ color: 'white', fontSize: 24 }}>CHá»ŒN ÄÆ N GIÃ</Text>
            </View>
                      ...
                      <TouchableOpacity
                        ...
                        <View style={styles.item}>
                          <View style={{ flexDirection: 'row' }}>
                            ...
                            <Text style={{ color: '#858585', fontSize: 18 }}> Ä‘</Text>
                          </View>
      ...
      <TouchableOpacity activeOpacity={0.7} onPress={_showModal}>
        <View style={styles.wrapper}>
          ...
          <Text style={{ color: '#858585', fontSize: fontSize * 75 / 100 }}> Ä‘</Text>
